...
![Diagrama Biblioteca](https://user-images.githubusercontent.com/30439829/148630572-db8e8fea-5def-4765-b8f1-77286943adae.png)</br>
El diagrama corresponde a un subcomponente de un sistema de gestión de una biblioteca, que permite llevar el registro de los libros existentes, sus autores, los estudiantes usuarios de la biblioteca y sus préstamos de libros.</br>
Los préstamos de un libro tienen una fecha definida de devolución, y una fecha efectiva de devolución, que permite verificar si hubo retrasos en dicha devolución.</br>
